    ...
    <div>
      <footer className="footer p-10 bg-base-200 text-base-content">
        ...
        <div>
          ...
          <a className="cursor-pointer hover:text-primary">Testimonials</a>
          <a className="cursor-pointer hover:text-primary">Site Map</a>
          <a className="cursor-pointer hover:text-primary">Brands</a>
          <a className="cursor-pointer hover:text-primary">Categories</a>
        </div>
        <div>
          <span className="footer-title">Legal</span>
          <a className="cursor-pointer hover:text-primary">Terms of use</a>
          <a className="cursor-pointer hover:text-primary">Privacy policy</a>
